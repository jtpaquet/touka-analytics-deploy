...
def generate_graphs():
    ...
    messages = database['messages_04avril2022']
    ...
    date_box = html.H3(children=f"{date_min} - {date_max}"),
    ...
    graphs = [*date_box, *g0, *g1, *g2, *g3, *g4, *g5]
...
app.layout = html.Div(children=[
    ...
    dcc.Loading(
        id="loading-1", type="default", className='lakasse-loading', children=html.Div(id="loading-output-1", className='lakasse-loading-div', children=[])
    )

])


@app.callback(Output("loading-output-1", "children"), Input("loading-1", "value"))
